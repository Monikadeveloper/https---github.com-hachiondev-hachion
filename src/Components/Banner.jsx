    ...
    <div className="carousel-inner">
      <div className="carousel-item active">
        ...
        <div className="carousel-caption">
          ...
          <h1 className='career-skills'>Enhance your career skills with the best online courses</h1>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption">
          ...
          <p className='banner-content'>Mastering Data Science: Live Q&A with Experts</p>
